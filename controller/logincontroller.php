...
$sql = "SELECT user_mst.email, role_mst.rolename from user_mst,role_mst,user_role_mapping where user_mst.uid=user_role_mapping.USERID and user_role_mapping.ROLEID=role_mst.roleid and user_mst.email='{$email}' and user_mst.password='{$password}'";
