...
<!-- <div class="content-inner"> -->
   <?php $sql = "SELECT orderid,orderstatus, orderdate, pid, expecteddate, amount, shippingcost, paymentmethod, time FROM order_mst,seller_product_mapping WHERE order_mst.pid=seller_product_mapping.productid and seller_product_mapping.sellerid=(select uid from user_mst where email='{$_SESSION['email']}') ORDER BY orderdate ASC, time DESC";
...
<?php while($row2 = mysqli_fetch_assoc($result2)){ ?>
        ...
        <div class="card-footer bg-white px-sm-3 pt-sm-4 px-0">
            ...
            <div class="col my-auto border-line">
                   <a href="viewrecievedorderdetails.php?oid=<?php echo"{$row['orderid']}" ?>&pid=<?php echo"{$productid}" ?>&odate=<?php echo"{$row['orderdate']}" ?>"><h5 class="btn btn-primary">View Details</h5></a>
                </div>
                <!-- <div class="col my-auto border-line ">
