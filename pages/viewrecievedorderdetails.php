...
<body style="background-color: #EEF5F9">
    ...
    margin: 0; border-bottom: none;">
                ...
                <center><h6 class="text-danger">Order Cancelled!</h6></center>
                <?php }else if($ostatus=="delivered"){ ?>
                    <center><h6>Sorry Can't Update Order Since it's already <?php echo"$ostatus" ?>!</h6>
                    <h5 type="button" class="btn btn-primary disabled">Update Order Details!</h5></center>
                <?php }else if($ostatus=="shipped" || $ostatus=="enrute" || $ostatus=="delivered"){ ?>
                        <center><h6>Sorry Can't Cancel Order Since it's already <?php echo"$ostatus" ?>!</h6>
                   <h5 class="btn btn-danger disabled" >Cancel Order!</h5>
                   <h5 type="button" class="ml-5 btn btn-primary" data-toggle="modal" data-target="#updateModal">Update Order Details!</h5></center>
                    <?php }else if($ostatus=="processed"){ ?>
                        <center><h5 type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">Cancel Order!</h5>
                        <h5 type="button" class="ml-5 btn btn-primary" data-toggle="modal" data-target="#updateModal">Update Order Details!</h5></center>
                        <?php } ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="../controller/cancelsellerrecievedordercontroller.php?oid=<?php echo"{$orderid}" ?>&pid=<?php echo"{$productid}" ?>&odate=<?php echo"{$orderdate}"?>"><button type="button" class="btn btn-danger">Cancel</button></a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
        Update :
        <form action="../controller/updaterecievedordercontroller.php?oid=<?php echo"{$orderid}" ?>&pid=<?php echo"{$productid}" ?>&odate=<?php echo"{$orderdate}"?>" method="post">
        <div class="row">
            <div class="col">        
        <select class="custom-select d-block w-100" name="orderstatusdetail" id="updatedetail" required>
                    <option value="">Choose...</option>
                    <option value="shipped">Shipped</option>
                    <option value="enrute">En Rute</option>
        ...
        <br>
        Do you really want to update the order. <strong>Press Update to update the order..</strong>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Don't Update</button>
        <!-- <a href="../controller/updaterecievedordercontroller.php?oid=<?php //echo"{$orderid}" ?>&pid=<?php //echo"{$productid}" ?>&odate=<?php //echo"{$orderdate}"?>"><button type="button" class="btn btn-danger">Update</button></a> -->
      </div>
    </div>
  </div>
</div>
